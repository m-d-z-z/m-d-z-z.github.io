...
sspanelKeyParam=$2
v2rayApiPortParam=$3
v2rayDownWithPanelParam=$4
v2rayPathParam=$5
v2rayLocalPortParam=$6
caddyListenPortParam=$7
nodeIdParam=$8
domainParam=$9
...
pre_install_docker_compose(){
    ...
    cloudflare_email="rico93@outlxxxxxxxxxx.com"
    echo
    echo "---------------------------"
    ...
    cloudflare_key="bbbbbbbbbbbbbbbbbb"
    echo
    echo "---------------------------"
